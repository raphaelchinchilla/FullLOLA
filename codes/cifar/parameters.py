...
def get_arguments():
    ...
    neural_net.add_argument("--lr_max", type=float, default=0.02, metavar="LR",
    ...
    neural_net.add_argument("--test_batch_size", type=int, default=256, metavar="N",
                            help="Batch size for test",
                            )
    neural_net.add_argument("--epochs", type=int, default=30, metavar="N",
    ...
    adv_training.add_argument("-tr_Ss", "--tr_step_size", type=float, default=120.,
                              metavar="", help="Step size for PGD, adv training",
                              )
    adv_training.add_argument("-tr_Ni", "--tr_num_iterations", type=int, default=5,
