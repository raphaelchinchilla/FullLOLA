...
def get_arguments():
    ...
    # Optimizer
    neural_net.add_argument("--lamda", type=float, default=10, metavar="lamb", help="Lambdaa",
                            )
    neural_net.add_argument("--lr", type=float, default=0.01, metavar="LR", help="Learning rate",
                            )

    neural_net.add_argument("--lr_inner", type=float, default=0.01, metavar="LR", help="Learning rate",
                            )
    ...
    neural_net.add_argument("--test_batch_size", type=int, default=512, metavar="N",
    ...
    adv_training.add_argument("-tr_Ss", "--tr_step_size", type=float, default=182.,
                              metavar="", help="Step size for PGD, adv training",
                              )
    adv_training.add_argument("-tr_Ni", "--tr_num_iterations", type=int, default=4,
